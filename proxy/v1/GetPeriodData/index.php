...
if (isset($decoded['url'], $decoded['userlogin'], $decoded['password'], $decoded['periodID']) && !empty($decoded['url'] . $decoded['userlogin'] . $decoded['password'] . $decoded['periodID'])) {
    getPeriodData($decoded['url'], $decoded['userlogin'], $decoded['password'], $decoded['periodID']);
} else {
...
function getPeriodData($schoolapi, $userlogin, $loginpass, $periodID){
    ...
    $url = sprintf("%s/GetPeriods", $schoolapi);

    $data = array(
        "UserLogin" => $userlogin,
        "Password" => $loginpass,
        "CurrentPage" => $currentPage,
        "PeriodTermID" => $periodID
    );
